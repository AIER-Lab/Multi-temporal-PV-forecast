...
sub_series_1 = pd.read_csv(os.path.join(directory, "SS1.csv"), parse_dates=['DateTime'],
                           index_col='DateTime')  # todo which are the columns in these .csv?
...
train_X_1, train_y_1, val_X_1, val_y_1, test_X_1, test_y_1, scaler_X_1, scaler_y_1, train_indices_1, val_indices_1, test_indices_1 = prepare_data(
    data_opt, supervised_df_1, original_indices_1)
train_X_2, train_y_2, val_X_2, val_y_2, test_X_2, test_y_2, scaler_X_2, scaler_y_2, train_indices_2, val_indices_2, test_indices_2 = prepare_data(
    data_opt, supervised_df_2, original_indices_2)
train_X_3, train_y_3, val_X_3, val_y_3, test_X_3, test_y_3, scaler_X_3, scaler_y_3, train_indices_3, val_indices_3, test_indices_3 = prepare_data(
    data_opt, supervised_df_3, original_indices_3)
train_X_4, train_y_4, val_X_4, val_y_4, test_X_4, test_y_4, scaler_X_4, scaler_y_4, train_indices_4, val_indices_4, test_indices_4 = prepare_data(
    data_opt, supervised_df_4, original_indices_4)
train_X_r, train_y_r, val_X_r, val_y_r, test_X_r, test_y_r, scaler_X_r, scaler_y_r, train_indices_r, val_indices_r, test_indices_r = prepare_data(
    data_opt, supervised_df_r, original_indices_r)
...
history_1 = model_1.fit(train_X_1, train_y_1, epochs=10, batch_size=32, validation_data=(val_X_1, val_y_1))

model_2 = lstm_model(data_opt['n_in'], data_opt['n_features'])
history_2 = model_2.fit(train_X_2, train_y_2, epochs=10, batch_size=32, validation_data=(val_X_2, val_y_2))

model_3 = lstm_model(data_opt['n_in'], data_opt['n_features'])
history_3 = model_3.fit(train_X_3, train_y_3, epochs=10, batch_size=32, validation_data=(val_X_3, val_y_3))

model_4 = lstm_model(data_opt['n_in'], data_opt['n_features'])
history_4 = model_4.fit(train_X_4, train_y_4, epochs=10, batch_size=32, validation_data=(val_X_4, val_y_4))
