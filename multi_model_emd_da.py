...
weights = [0.7099154, -0.58873344, -0.38710705, -0.20811667, 1, 1, 1, 1, 1, 1, 1]
...
results.to_csv('results_emd_multi_day.csv')
...
final_prediction_weighted = (inv_yhat_1[start_idx:end_idx] * optimized_weights[0] +
                             ...
                             inv_yhat_1[start_idx:end_idx] * optimized_weights[4] +
                             inv_yhat_2[start_idx:end_idx] * optimized_weights[5] +
                             inv_yhat_3[start_idx:end_idx] * optimized_weights[6] +
                             inv_yhat_4[start_idx:end_idx] * optimized_weights[7] +
                             inv_yhat_2[start_idx:end_idx] * optimized_weights[8] +
                             inv_yhat_3[start_idx:end_idx] * optimized_weights[9] +
                             inv_yhat_4[start_idx:end_idx] * optimized_weights[10]
                             )
